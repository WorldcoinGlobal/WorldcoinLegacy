...
QString WorldcoinUnits::name(int unit)
{
    switch(unit)
    {
...
QString WorldcoinUnits::description(int unit)
{
    ...
    case mWDC: return QString("Milli-Worldcoins (1 / 1,000)");
    case uWDC: return QString("Micro-Worldcoins (1 / 1,000,000)");
    default: return QString("???");
    }
}
...
int WorldcoinUnits::amountDigits(int unit)
{
    switch(unit)
    {
...
QString WorldcoinUnits::format(int unit, qint64 n, bool fPlus)
{
...
QString WorldcoinUnits::formatWithUnit(int unit, qint64 amount, bool plussign)
{
    return format(unit, amount, plussign) + QString(" ") + name(unit);
}

bool WorldcoinUnits::parse(int unit, const QString &value, qint64 *val_out)
{
