...
void WorldcoinGUI::SetMiningStatus(bool isMining)
{
    //if(ui->checkBox)
       // ui->checkBox->setChecked(isMining);
}

WorldcoinGUI::~WorldcoinGUI()
{
    //saveWindowGeometry();
...
void WorldcoinGUI::createActions(bool fIsTestnet)
{
...
void WorldcoinGUI::createMenuBar()
{
#ifdef Q_OS_MAC
...
void WorldcoinGUI::createToolBars()
{
...
void WorldcoinGUI::setClientModel(ClientModel *clientModel)
{
...
void WorldcoinGUI::setWalletModel(WalletModel *walletModel)
{
...
void WorldcoinGUI::createTrayIcon()
{
#ifndef Q_OS_MAC
...
void WorldcoinGUI::createTrayIconMenu()
{
    QMenu *trayIconMenu;
#ifndef Q_OS_MAC
...
#ifndef Q_OS_MAC
void WorldcoinGUI::trayIconActivated(QSystemTrayIcon::ActivationReason reason)
{
...
void WorldcoinGUI::saveWindowGeometry()
{
    QSettings settings;
...
void WorldcoinGUI::restoreWindowGeometry()
{
    QSettings settings;
...
void WorldcoinGUI::optionsClicked()
{
...
void WorldcoinGUI::aboutClicked()
{
...
void WorldcoinGUI::setNumConnections(int count)
{
    QString icon;
    switch(count)
    {
...
void WorldcoinGUI::setNumBlocks(int count, int nTotalBlocks)
{
...
void WorldcoinGUI::message(const QString &title, const QString &message, unsigned int style, bool *ret)
{
...
void WorldcoinGUI::closeEvent(QCloseEvent *event)
{
    if(clientModel)
    {
#ifndef Q_OS_MAC // Ignored on Mac
...
void WorldcoinGUI::askFee(qint64 nFeeRequired, bool *payFee)
{
    QString strMessage = tr("This transaction is over the size limit. You can still send it for a fee of %1, "
        "which goes to the nodes that process your transaction and helps to support the network. "
        "Do you want to pay the fee?").arg(WorldcoinUnits::formatWithUnit(WorldcoinUnits::WDC, nFeeRequired));
...
//void WorldcoinGUI::incomingTransaction(const QString& date, int unit, qint64 amount, const QString& type, const QString& address)
void WorldcoinGUI::incomingTransaction(const QModelIndex& parent, int start, int /*end*/)
{
    ...
    message((amount)<0 ? tr("Sent transaction") : tr("Incoming transaction"),
             tr("Date: %1\n"
                ...
                "Address: %4\n")
                  .arg(date)
                  .arg(WorldcoinUnits::formatWithUnit(walletModel->getOptionsModel()->getDisplayUnit(), amount, true))
                  .arg(type)
                  .arg(address), CClientUIInterface::MSG_INFORMATION);
}

void WorldcoinGUI::gotoOverviewPage()
{
...
void WorldcoinGUI::gotoHistoryPage()
{
...
void WorldcoinGUI::gotoAddressBookPage()
{
...
void WorldcoinGUI::gotoReceiveCoinsPage()
{
...
//void WorldcoinGUI::gotoSendCoinsPage(QString addr)
void WorldcoinGUI::gotoSendCoinsPage()
{
...
void WorldcoinGUI::gotoSignMessageTab(QString addr)
{
...
void WorldcoinGUI::gotoVerifyMessageTab(QString addr)
{
...
void WorldcoinGUI::dropEvent(QDropEvent *event)
{
    if(event->mimeData()->hasUrls())
    {
...
bool WorldcoinGUI::eventFilter(QObject *object, QEvent *event)
{
...
void WorldcoinGUI::resizeEvent(QResizeEvent *e)
{
    updateMask();
    QMainWindow::resizeEvent(e);
}

void WorldcoinGUI::paintEvent(QPaintEvent *e)
{
    Q_UNUSED(e);
...
void WorldcoinGUI::handleURI(QString strURI)
{
    // URI has to be valid
...
void WorldcoinGUI::menuFileRequested()
{
    QMenu menu(this);
...
void WorldcoinGUI::menuOperationsRequested()
{
    QMenu menu(this);
    QAction* send = menu.addAction(tr("Send Worldcoins"));
    QAction* receive = menu.addAction(tr("Receive Worldcoins"));
...
void WorldcoinGUI::setEncryptionStatus(int status)
{
    switch(status)
    {
...
void WorldcoinGUI::encryptWallet(bool status)
{
    if(!walletModel)
        return;
...
void WorldcoinGUI::changePassphrase()
{
...
void WorldcoinGUI::unlockWallet()
{
    if(!walletModel)
        return;
...
void WorldcoinGUI::showNormalIfMinimized(bool fToggleHidden)
{
...
void WorldcoinGUI::toggleHidden()
{
    showNormalIfMinimized(true);
}

void WorldcoinGUI::detectShutdown()
{
    if (ShutdownRequested())
        QMetaObject::invokeMethod(QCoreApplication::instance(), "quit", Qt::QueuedConnection);
}

void WorldcoinGUI::onMiningClicked()
{
