...
contains(WORLDCOIN_NEED_QT_PLUGINS, 1) {
    DEFINES += WORLDCOIN_NEED_QT_PLUGINS
...
HEADERS += src/qt/worldcoingui.h \
    ...
    src/qt/worldcoinaddressvalidator.h \
    src/alert.h \
    src/addrman.h \
    src/base58.h \
    src/bignum.h \
...
SOURCES += src/qt/worldcoin.cpp \
    ...
    src/qt/worldcoinaddressvalidator.cpp \
    src/alert.cpp \
    src/version.cpp \
    src/sync.cpp \
    src/util.cpp \
    ...
    src/qt/worldcoinstrings.cpp \
    src/qt/worldcoinamountfield.cpp \
    src/wallet.cpp \
    src/keystore.cpp \
    src/qt/transactionfilterproxy.cpp \
    src/qt/transactionview.cpp \
    src/qt/walletmodel.cpp \
    src/worldcoinrpc.cpp \
    src/rpcdump.cpp \
    src/rpcnet.cpp \
    src/rpcmining.cpp \
    src/rpcwallet.cpp \
...
# also add new translations to src/qt/worldcoin.qrc under translations/
TRANSLATIONS = $$files(src/qt/locale/worldcoin_*.ts)
...
win32:RC_FILE = src/qt/res/worldcoin-qt.rc
